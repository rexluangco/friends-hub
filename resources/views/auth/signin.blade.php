  ...
  <div class="col-4">
    <div class="card border-primary">
      <div class="card-header bg-primary">
        <h3 class="font-weight-bold text-light"><i class="fa fa-user-lock"></i> Sign In</h3>
      </div>
      <div class="card-body">

        <form method="post" role="form" action="{{route('auth.signin')}}">
            ...
            <a  href="{{route('auth.signup')}}"><small>No account yet?Click here to register.</small></a>
